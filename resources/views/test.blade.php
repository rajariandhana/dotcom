<x-layout  title="Testing Page">
    ...
    <div class="p-4 bg-indigo-950 rounded-3xl w-3/4">
        <div x-data="{}" x-init="$nextTick(() => {
            ...
            <ul x-ref="logos"
                class="flex items-center justify-center md:justify-start [&_li]:mx-4 [&_img]:max-w-none animate-infinite-scroll-10-LR">
                <li>
